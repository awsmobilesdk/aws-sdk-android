...
/**
 * JSON marshaller for POJO CalculateRouteMatrixSummary
 */
class CalculateRouteMatrixSummaryJsonMarshaller {

    public void marshall(CalculateRouteMatrixSummary calculateRouteMatrixSummary,
            AwsJsonWriter jsonWriter) throws Exception {
        jsonWriter.beginObject();
        if (calculateRouteMatrixSummary.getDataSource() != null) {
            String dataSource = calculateRouteMatrixSummary.getDataSource();
    ...
    private static CalculateRouteMatrixSummaryJsonMarshaller instance;

    public static CalculateRouteMatrixSummaryJsonMarshaller getInstance() {
        if (instance == null)
            instance = new CalculateRouteMatrixSummaryJsonMarshaller();
        return instance;
    }
}
