...
/**
 * JSON unmarshaller for POJO ListTrackersResponseEntry
 */
class ListTrackersResponseEntryJsonUnmarshaller implements
        Unmarshaller<ListTrackersResponseEntry, JsonUnmarshallerContext> {
