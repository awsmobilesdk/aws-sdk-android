...
/**
 * JSON unmarshaller for POJO BatchEvaluateGeofencesError
 */
class BatchEvaluateGeofencesErrorJsonUnmarshaller implements
        Unmarshaller<BatchEvaluateGeofencesError, JsonUnmarshallerContext> {
