...
/**
 * JSON unmarshaller for POJO CalculateRouteSummary
 */
class CalculateRouteSummaryJsonUnmarshaller implements
        Unmarshaller<CalculateRouteSummary, JsonUnmarshallerContext> {
