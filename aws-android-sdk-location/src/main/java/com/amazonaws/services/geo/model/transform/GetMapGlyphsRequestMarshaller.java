...
/**
 * JSON request marshaller for GetMapGlyphsRequest
 */
public class GetMapGlyphsRequestMarshaller implements
        Marshaller<Request<GetMapGlyphsRequest>, GetMapGlyphsRequest> {

    public Request<GetMapGlyphsRequest> marshall(GetMapGlyphsRequest getMapGlyphsRequest) {
        if (getMapGlyphsRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(GetMapGlyphsRequest)");
        }

        Request<GetMapGlyphsRequest> request = new DefaultRequest<GetMapGlyphsRequest>(
                getMapGlyphsRequest, "AmazonLocation");
