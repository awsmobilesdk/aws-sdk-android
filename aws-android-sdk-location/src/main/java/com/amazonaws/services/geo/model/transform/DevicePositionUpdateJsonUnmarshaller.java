...
/**
 * JSON unmarshaller for POJO DevicePositionUpdate
 */
class DevicePositionUpdateJsonUnmarshaller implements
        Unmarshaller<DevicePositionUpdate, JsonUnmarshallerContext> {
