...
/**
 * JSON unmarshaller for response PutGeofenceResult
 */
public class PutGeofenceResultJsonUnmarshaller implements
        Unmarshaller<PutGeofenceResult, JsonUnmarshallerContext> {
