...
/**
 * JSON request marshaller for ListKeysRequest
 */
public class ListKeysRequestMarshaller implements
    ...
    public Request<ListKeysRequest> marshall(ListKeysRequest listKeysRequest) {
        ...
        Request<ListKeysRequest> request = new DefaultRequest<ListKeysRequest>(listKeysRequest,
                "AmazonLocation");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/metadata/v0/list-keys";
        ...
        try {
            ...
            if (listKeysRequest.getNextToken() != null) {
