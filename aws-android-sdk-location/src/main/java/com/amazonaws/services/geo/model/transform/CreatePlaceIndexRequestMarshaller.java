...
/**
 * JSON request marshaller for CreatePlaceIndexRequest
 */
public class CreatePlaceIndexRequestMarshaller implements
        Marshaller<Request<CreatePlaceIndexRequest>, CreatePlaceIndexRequest> {
    ...
    public Request<CreatePlaceIndexRequest> marshall(CreatePlaceIndexRequest createPlaceIndexRequest) {
        if (createPlaceIndexRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreatePlaceIndexRequest)");
        }

        Request<CreatePlaceIndexRequest> request = new DefaultRequest<CreatePlaceIndexRequest>(
                createPlaceIndexRequest, "AmazonLocation");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/places/v0/indexes";
