...
/**
 * JSON request marshaller for CreateTrackerRequest
 */
public class CreateTrackerRequestMarshaller implements
        Marshaller<Request<CreateTrackerRequest>, CreateTrackerRequest> {

    public Request<CreateTrackerRequest> marshall(CreateTrackerRequest createTrackerRequest) {
        if (createTrackerRequest == null) {
            throw new AmazonClientException(
                    "Invalid argument passed to marshall(CreateTrackerRequest)");
        }

        Request<CreateTrackerRequest> request = new DefaultRequest<CreateTrackerRequest>(
                createTrackerRequest, "AmazonLocation");
        request.setHttpMethod(HttpMethodName.POST);

        String uriResourcePath = "/tracking/v0/trackers";
